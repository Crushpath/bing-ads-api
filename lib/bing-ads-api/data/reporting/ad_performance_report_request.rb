...
module BingAdsApi
	...
	#
  # Author:: jzcorcuera@gmail.com
	#
	# === Usage
	#
	#   request = BingAdsApi::AdPerformanceReportRequest.new(
	#     :format   => :xml,
	#     :language => :english,
  ...
  #       :ad_groups => [<BingAdsApi::AdGroupReportScope>],
    ...
    #       :ad_groups => [<BingAdsApi::AdGroupReportScope>],
		...
		#     :time => :this_week)
		#
		#   request2 = BingAdsApi::AdPerformanceReportRequest.new(
		#     :format   => :csv,
		#     :language => :french,
		#     :report_name => "Me report",
		#     :aggregation => :daily,
    ...
    #       :ad_groups => [<BingAdsApi::AdGroupReportScope>],
      ...
      #
      # Reference: http://msdn.microsoft.com/en-us/library/bing-ads-reporting-adgroupreportscope.aspx
			#
      # Author:: jzcorcuera@gmail.com
			#
			# === Parameters
        ...
        raise Exception.new("Invalid scope: no account_ids key") if !scope.key?(:account_ids)
				raise Exception.new("Invalid scope: no ad_groups key") if !scope.key?(:ad_groups)
			...
			#
      # Reference: http://msdn.microsoft.com/en-US/library/bing-ads-reporting-accountthroughadgroupreportscope.aspx
      #
      # Author:: jzcorcuera@gmail.com
			#
			# === Parameters
      ...
      # Author:: jzcorcuera@gmail.com
			#
			# Returns:: "v9:AdPerformanceReportRequest"
